...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand" href="http://localhost/phpCRUDProj/">寵物後台 -</a>
        <a class="navbar-brand" href="#">寵物首頁</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?= $page_name == 'data-list' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= WEB_ROOT ?>/pet_info/data-list.php">問券列表</a>
                </li>
                <li class="nav-item <?= $page_name == 'data-insert' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= WEB_ROOT ?>/pet_info/data-insert.php">問券新增</a>
                </li>
            </ul>
            <ul class="navbar-nav">
