        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($rows as $r) : ?>
                    <tr>
                        <?php if (isset($_SESSION['admin'])) : ?>
                            <td><a href="data_delete_test.php?sid=<?= $r['order_id'] ?>" onclick="ifDel(event)" data-sid="<?= $r['order_id'] ?>">
                        ...
                        <?php if (isset($_SESSION['admin'])) : ?>
                            <td><a href="data_edit_test.php?order_id=<?= $r['order_id'] ?>"><i class="fas fa-edit"></i></a></td>
                        <?php endif; ?>
                    </tr>
...
<script>
    function ifDel(event) {
        ...
        const sid = a.getAttribute('data-name');
